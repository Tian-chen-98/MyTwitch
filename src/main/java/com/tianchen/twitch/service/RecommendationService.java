...
public class RecommendationService {
    ...
    private List<Item> recommendByFavoriteHistory(
        ...
        // Sort the game Id by count DESC. E.g. if the input is {"1234": 1, "2345": 2, "3456": 1}, the returned Map is {"2345": 2, "1234": 1, "3456": 1}
        ...
        // the outer for loop will be performed at most 3 times as we have truncated sortedFavoriteGameIdListByCount
        for (Map.Entry<String, Long> favoriteGame : sortedFavoriteGameIdListByCount) {
            ...
            // this for loop will be performed at most 10 times as DEFAULT_PER_GAME_RECOMMENDATION_LIMIT = 10
            for (Item item : items) {
                if (recommendedItems.size() == DEFAULT_TOTAL_RECOMMENDATION_LIMIT) {
                    return recommendedItems;
                }
