...
public class ApplicationConfig {
   ...
   public LocalSessionFactoryBean sessionFactory() {
       ...
       // set db package path
       sessionFactory.setPackagesToScan("com.tianchen.twitch.entity.db");
   ...
   public DataSource dataSource() {
       String RDS_ENDPOINT = "tc-instance.cjxrn75lvpg5.us-east-1.rds.amazonaws.com";
       String USERNAME = "admin";
       String PASSWORD = "Ct990714!";
